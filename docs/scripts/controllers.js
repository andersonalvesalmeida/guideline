...
angular
	...
	, function($scope, $routeParams, $location, $rootScope){
      ...
      {nome: 'Datagrid', descricao: 'Datagrid', view: 'datagrid', classificacao: 'Componentes'},
      {nome: 'Mascaras', descricao: 'Mascaras', view: 'mascaras', classificacao: 'Componentes'},
      {nome: 'Notification center', descricao: 'Notification center', view: 'notification-center', classificacao: 'Componentes'},
